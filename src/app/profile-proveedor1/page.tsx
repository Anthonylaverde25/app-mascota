            ...
            <div className="grid grid-cols-12 gap-6">
                ...
                <Card>
                  <CardContent className="p-6">
                    <div className="flex flex-col items-center text-center mb-6">
                      ...
                      <h2 className="text-xl font-bold mb-1">Clínica Veterinaria Amigo Fiel</h2>
                      <p className="text-sm text-muted-foreground">#VET249654</p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                          <div className="flex items-start gap-3 text-sm">
                            ...
                            <div>
                              ...
                              <p className="font-medium">(629) 555-0123</p>
                            </div>
                          </div>
                          <div className="flex items-start gap-3 text-sm">
                            ...
                            <div>
                              ...
                              <p className="font-medium text-xs break-all">clinicavet.fiel@example.com</p>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="space-y-3">
                          <div className="flex items-start gap-3 text-sm">
                            ...
                            <div>
                              ...
                              <p className="font-medium">390 Market Street, Suite 200</p>
                            </div>
                          </div>
                          <div className="flex items-start gap-3 text-sm">
                            <Building className="h-4 w-4 text-muted-foreground mt-0.5" />
                            <div>
                              <p className="text-muted-foreground text-xs">Ciudad/Estado</p>
                          ...
                          <div className="flex items-start gap-3 text-sm">
                            ...
                            <div>
                              ...
                              <p className="font-medium">94102</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="border-t pt-4">
                        <h3 className="text-sm font-semibold mb-3">Detalles del Equipo</h3>
                        <div className="space-y-3">
                           <div className="flex items-start gap-3 text-sm">
                            <IdCard className="h-4 w-4 text-muted-foreground mt-0.5" />
                            <div>
                              <p className="text-muted-foreground text-xs">Gerente General</p>
                              <p className="font-medium">Dr. Ricardo Pérez</p>
                            </div>
                          </div>
                          <div className="flex items-start gap-3 text-sm">
                            <Calendar className="h-4 w-4 text-muted-foreground mt-0.5" />
                            <div>
                              <p className="text-muted-foreground text-xs">Fecha de Fundación</p>
                              <p className="font-medium">Jan 05, 2010</p>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="col-span-12 lg:col-span-9 space-y-6">
                <Card>
                  <CardContent className="p-6">
                    <div className="flex justify-between items-center mb-4">
                      <h3 className="text-lg font-semibold">Staff Profesional</h3>
                      ...
                      <table className="w-full">
                        <thead>
                          <tr className="border-b text-left text-xs text-muted-foreground uppercase">
                            ...
                            <th className="pb-3 font-medium">División</th>
                            <th className="pb-3 font-medium">Responsable</th>
                            <th className="pb-3 font-medium">Fecha de Contratación</th>
                        ...
                        <tbody className="text-sm">
                          {jobData.map((job, index) => (
                            <tr key={index} className="border-b last:border-0">
                              ...
                              <td className="py-4">{job.division}</td>
                              <td className="py-4">{job.manager}</td>
                              <td className="py-4">{job.hireDate}</td>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                          ...
                          <div key={index} className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              <p className="text-sm">
                                ...
                                <span className="text-muted-foreground">el {activity.date}</span>
                              </p>
                  ...
                  <Card>
                    <CardContent className="p-6">
                      <h3 className="text-lg font-semibold mb-4">Facturación Reciente</h3>
                      <div className="space-y-4">
                        {compensationData.map((comp, index) => (
                          <div key={index} className="border-b last:border-0 pb-4 last:pb-0">
                            <p className="text-lg font-semibold">
                              {comp.amount} <span className="text-sm font-normal text-muted-foreground">{comp.period}</span>
                            </p>
                            <p className="text-xs text-muted-foreground">
                              Fecha efectiva el {comp.effectiveDate}
                            </p>
                          </div>
                        ))}
                        <Button variant="link" className="text-primary hover:text-primary/80 p-0 text-sm">
